...
import in.co.student.info.form.ChangePasswordForm;
import in.co.student.info.form.MyProfileForm;
import in.co.student.info.form.UserForm;
import in.co.student.info.service.RoleServiceInt;
import in.co.student.info.service.UserServiceInt;
import in.co.student.info.util.BCryptPassword;
...
public class UserCtl extends BaseCtl {
	...
	@RequestMapping(value = "/Search/Admin", method = { RequestMethod.GET, RequestMethod.POST })
	public String searchList(Locale locale, @ModelAttribute("form") UserForm form,
		...
		if (OP_RESET.equalsIgnoreCase(operation)) {
			return "redirect:/ctl/User/Search/Admin";
		}
	...
	@RequestMapping(value = "/Search/Student", method = { RequestMethod.GET, RequestMethod.POST })
	public String searchListStudent(Locale locale, @ModelAttribute("form") UserForm form,
			@RequestParam(required = false) String operation,HttpSession session, Model model) {
		...
		if (OP_RESET.equalsIgnoreCase(operation)) {
			return "redirect:/ctl/User/Search/Student";
		}
	...
	@RequestMapping(value = "/Search/Faculty", method = { RequestMethod.GET, RequestMethod.POST })
	public String searchListFaculty(Locale locale, @ModelAttribute("form") UserForm form,
			@RequestParam(required = false) String operation,HttpSession session, Model model) {
		...
		if (OP_RESET.equalsIgnoreCase(operation)) {
			return "redirect:/ctl/User/Search/Faculty";
		}
	...
	public String submitChangePassword(Locale locale, HttpSession session,
		...
		if (userservice.changePassword(dto.getId(), form.getOldPassword(),form.getNewPassword())) {
			...
			String msg = messageSource.getMessage("message.unsuccess.changePasswordNotMatch", null, locale);
			model.addAttribute("error", msg);
